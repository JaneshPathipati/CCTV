...
export default function WhatsAppChat() {
  ...
  const phoneNumber = '+918282824138'
  const message = 'Hi! I would like to know more about HSO CCTV products and services.'
  ...
  return (
    <>
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-500 p-4 text-white">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold">HSO CCTV Support</h3>
          ...
          <div className="p-4 bg-gray-50">
            <div className="bg-white rounded-lg p-3 shadow-sm mb-3">
              ...
              <p className="text-xs text-gray-500 mt-2">
                We're here to assist with CCTV installation, products, and support.
              </p>
            </div>
            <Link
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-green-600 hover:bg-green-700 text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 group"
